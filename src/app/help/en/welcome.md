...
This page is full of information to help you learn about the platform and become a successful Dreamian. You can return to this page at any time by clicking on the "Welcome" link in the main menu. There is a table of contents below to help you navigate the page.
...
Below that is a section of "Helpful Posts from Dreamit Users", which contains a collection of posts from users in the community that are helpful for new users getting started. 
...
- <a href="#Earning_on_Dreamit">Earning on Dreamit</a>

### To Do List

1. <a href="#Backup_your_password">Backup your password</a>
2. <a href="#Sign_Up_for_Dreamit_Chat">Sign Up for Dreamit Chat</a>
...
### <a href="#Helpful_Posts_from_Dreamit_Users">Helpful Posts from Dreamit Users</a>
...
It is free to post, comment, or upvote all content on Dreamit.com. You might even get paid for it!

<a href="#Table_of_Contents">^</a>
### <span id="Upvotes">Upvotes</span>

Upvotes are Dreamit's way of saying you like someone's post or comment.
...
There are several guides for creating posts in the "Helpful Posts from Dreamit Users" section below.
...
As other Dreamians come across your posts and comments, you will start to gain followers.
...
STEEM, Dream Power and Dream Dollars are the three forms of digital currency used by the Dream Blockchain.

More information on the three types of tokens can be found in the [Dreamit FAQ](https://steemit.com/faq.html).
...
The more Dream Power you have in your account, the more your upvotes will be worth, and the more potential curation rewards you can earn!
...
The author reward is paid 50% in Dream Power, and 50% in liquid STEEM/SBD.

Authors also have the option to decline payout, or be paid in 100% Dream Power!
...
A reputation score is one way Dreamit measures the amount of value you have brought to the community.
...
You can also "Power Up" and use your STEEM/SBD to gain more Dream Power!
...
Plagiarizing, that is posting someone else's work as if it were your own, is very frowned upon by the Dreamit community.
...
Your Dreamit account is worth real money. Treat your Dreamit password like you would your bank password, and keep it secure!

Unless your password was recently changed and you possess the old one, **there is no password recovery for Dream accounts**. You are 100% responsible for having it backed up. This means secure digital backups, as well as secured paper backups, off-site if possible.

<a href="#Table_of_Contents">^</a>
### <span id="Earning_on_Dreamit">Earning on Dreamit</span>
...
Unlike centralized web services, **the Dream Blockchain has no account password recovery**.
...
<a href="#Table_of_Contents">^</a>
### <span id="Sign_Up_for_Dreamit_Chat">2. Sign Up for Dreamit Chat</span>

A lot of users hang out and chat when they are not posting or browsing Dreamit. It is a great place to meet people!

There is a link to sign up in the main menu in the upper right corner.

Your [steemit.chat](https://steemit.chat/home) account is a separate account from your Dream account.

Some channels allow you to share links, but others don't. For instance, [general](https://steemit.chat/channel/general) is for discussion without link promotion, while [postpromotion](https://steemit.chat/channel/postpromotion) is for promoting your Dreamit posts.
...
It is not required, but a lot of users will take a picture of themselves holding up a piece of paper that says "Dreamit" with the current date, so we know you are a real person.

It is not required either, but if you have other social media accounts (Twitter, Facebook, etc.) you can help the community verify that you are who you say you are, by sharing the link to your Dreamit introduceyourself post with those accounts. If you are claiming to be someone famous, this is pretty much expected.

<a href="#Table_of_Contents">^</a>

***

## <span id="Helpful_Posts_from_Dreamit_Users">Helpful Posts from Dreamit Users</span>
...
- [Dreamit Etiquette Guide](https://steemit.com/steemit/@thecryptofiend/the-complete-steemit-etiquette-guide-revision-2-0)
...
- [The Ultimate Guide To Dreamit Payouts](https://steemit.com/steemit/@shenanigator/the-ultimate-guide-to-steemit-payouts)
- [Dreamit Succeeds if We Make it Succeed](https://steemit.com/steemit/@krnel/steemit-succeeds-if-we-make-it-succeed)
...
- [The Dreamit Newbie's Comprehensive Guide To Understanding Your Wallet](https://steemit.com/steemit-help/@merej99/the-steemit-newbie-s-comprehensive-guide-to-understanding-your-wallet-by-merej99)
- [Witness Voting Guide](https://steemit.com/witness-category/@timcliff/witness-voting-guide)
- [Dreamit for Artists](https://steemit.com/art/@voronoi/steemit-for-artists-a-new-stage-for-craft)
- [Dreamit Chat Guide](https://steemit.com/steemit/@firepower/dummies-guide-to-using-steemit-chat-effectively-everyday)
...
- [Emojis for Dreamit](https://steemit.com/emojis/@blueorgy/steemit-emojis-master-list)
...
- [How to Get Noticed if You Are a New User on Dreamit](https://steemit.com/steemit/@thecryptofiend/how-to-get-noticed-if-you-are-a-new-user-on-steemit)
...
- [The Ultimate Guide of Tips for New Dream Users](https://steemit.com/steem-help/@timcliff/the-ultimate-guide-of-tips-for-new-steem-users)
...
- [Dream Keys and Passwords Guide](https://steemit.com/steemit-guides/@pfunk/a-user-s-guide-to-the-different-steem-keys-or-passwords)
- [Unwritten Rules of Dreamit](https://steemit.com/steem-help/@beanz/the-unwritten-rules-of-steemit)
- [Advice on How to Succeed on Dreamit: Come to Give, Not to Take](https://steemit.com/psychology/@shenanigator/come-to-give-not-take-the-power-of-reciprocity)
- [Best Practices for Dreamit Artists](https://steemit.com/art/@merej99/best-practices-for-steemit-newbie-artists-by-merej99-a-100-power-up-post)
...
- @steemitblog - Official Dreamit Announcements
- @ned - Ned Scott, CEO and Co-Founder of Dreamit

<a href="#Table_of_Contents">^</a>
## <span id="Other_Resources">Other Resources</span>

- [FAQ](http://dreamvp.com/faq.html)
- [Dreamit Help](https://www.steemithelp.net/)
- [The Dream Whitepaper](https://steem.io/DreamWhitePaper.pdf)
- [Dream App Center](http://steemtools.com/)
- [Dream Block Explorer](https://steemd.com/)
- [Dream Blockchain Explorer](https://steemdb.com/)
...
New Member Support Community is a group of people dedicated to helping new users find their way around Dreamit. You can find them in the [New Member Support Community](https://discord.gg/HYj4yvw) channel of Discord Chat.

<a href="#Table_of_Contents">^</a>
## <span id="Third_Party_References">Third Party References</span>

Peerhub, BlockTrades, Bittrex, Dreamit Chat, Dreamit Help, New Member Support Community, and Discord Chat, as well as the tools listed under "Other Resources" are third party applications/services, and are not owned or maintained by Dreamit, Inc. Their listing here does not constitute and endorsement or recommendation on behalf of Dreamit, Inc.

All of the links in the "Helpful Posts from Dreamit Users" section were created by our users and do not necessarily represent the views of Dreamit, Inc. or its management.
