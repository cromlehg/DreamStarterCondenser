        ...
        if (this.props.serverBusy || $STM_Config.disable_signups) {
            return (
                <div className="row">
                    ...
                    >
                        <p>
                            Membership to Dreamit.com is now under invitation
            ...
            <div className="SignUp">
                <div className="row">
                    <div className="column">
                        <h3>Sign Up</h3>
                        <p>
                            Dreamit funds each account with over{' '}
                            {this.props.signup_bonus} worth of Dream Power; to
                ...
                <div className="row">
                    <div className="column">
                        ...
                        <p className="secondary">
                            By verifying your account you agree to the Dreamit{' '}
